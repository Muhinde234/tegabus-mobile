...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String bus,  double price,  String? driverName,  String? driverPhone,  String from,  String to,  DateTime departureTime,  DateTime arrivalTime,  int totalSeats,  int remainingSeats)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Schedule() when $default != null:
return $default(_that.id,_that.bus,_that.price,_that.driverName,_that.driverPhone,_that.from,_that.to,_that.departureTime,_that.arrivalTime,_that.totalSeats,_that.remainingSeats);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String bus,  double price,  String? driverName,  String? driverPhone,  String from,  String to,  DateTime departureTime,  DateTime arrivalTime,  int totalSeats,  int remainingSeats)  $default,) {final _that = this;
switch (_that) {
case _Schedule():
return $default(_that.id,_that.bus,_that.price,_that.driverName,_that.driverPhone,_that.from,_that.to,_that.departureTime,_that.arrivalTime,_that.totalSeats,_that.remainingSeats);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String bus,  double price,  String? driverName,  String? driverPhone,  String from,  String to,  DateTime departureTime,  DateTime arrivalTime,  int totalSeats,  int remainingSeats)?  $default,) {final _that = this;
switch (_that) {
case _Schedule() when $default != null:
return $default(_that.id,_that.bus,_that.price,_that.driverName,_that.driverPhone,_that.from,_that.to,_that.departureTime,_that.arrivalTime,_that.totalSeats,_that.remainingSeats);case _:
  return null;
